...
startindex=9
# outputfile='__OUTPUT_FILE__'
targetgenelist=c("CBLL1","APAF1","ACVR1B","SOX4","NOTCH1","BAX","CYCS","SUZ12","C17ORF49","HNF4A")
# samplelabel=sub('.\\w+.\\w+$','',colnames(gstable)[startindex]);
...
# parameters
# Do not modify the variables beginning with "__"
targetmat=list(c(5941.47239211708,13882.228167286812),c(3539.8880426030128,6045.18062842155),c(4907.8791277692535,9138.876772411837),c(4495.79292433646,7761.79386901528),c(3306.8228947598755,6100.287646500672),c(3502.7327291787446,7099.9171034843175))
targetgene="C17ORF49"
collabel=c("D0","D3Pos")
...
# parameters
# Do not modify the variables beginning with "__"
targetmat=list(c(2921.7587374538225,6337.899627680543),c(7049.376283313442,13437.224182583364),c(1943.8984432423988,4425.745355193154),c(2643.0938867718105,6407.227811715567),c(4774.457775018472,12224.277236261181),c(1704.0777838675763,1048.2184406663125))
targetgene="HNF4A"
collabel=c("D0","D3Pos")
